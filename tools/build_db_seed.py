...
def seed_db():
    with get_db() as db:
        ...
        print("Seeding CAPACITY CONNECT database with MoES/IMD data...")
        ...
        print("CAPACITY CONNECT database successfully seeded!")
'''

with open("app/database.py", "a", encoding="utf-8") as f:
    f.write(seed_code)
print("app/database.py seed appended successfully")
