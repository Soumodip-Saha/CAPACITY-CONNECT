...
admin_routes_code = '''from typing import Optional, List
...
def competency_mapping_page(
    ...
    return templates.TemplateResponse("admin/competency_map.html", {
        "request": request,
        "user": user,
...
print("app/routes/admin_routes.py created successfully")
