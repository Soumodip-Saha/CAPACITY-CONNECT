...
with open("app/services/competency_engine.py", "w", encoding="utf-8") as f:
    f.write(services_code)
with open("app/services/certificate_service.py", "w", encoding="utf-8") as f:
    f.write(services_code)
...
print("app/services generated successfully")
