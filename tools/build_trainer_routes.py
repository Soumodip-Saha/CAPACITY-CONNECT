...
trainer_routes_code = '''import json
...
def trainer_courses(request: Request):
    ...
    return templates.TemplateResponse("trainer/courses.html", {
        "request": request,
        "user": user,
        "courses": courses,
        "domains": domains,
...
def manage_course_content(request: Request, course_id: int):
    ...
    return templates.TemplateResponse("trainer/course_manage.html", {
        "request": request,
        "user": user,
        "course": course,
        "modules": modules,
...
def create_quiz_page(request: Request, course_id: Optional[int] = None):
    ...
    return templates.TemplateResponse("trainer/create_quiz.html", {
        "request": request,
        "user": user,
        "courses": courses,
...
def trainer_library_page(request: Request):
    ...
    return templates.TemplateResponse("trainer/library.html", {
        "request": request,
        "user": user,
        "resources": resources,
        "domains": domains
...
def trainer_analytics(request: Request):
    ...
    return templates.TemplateResponse("trainer/analytics.html", {
        "request": request,
        "user": user,
        "stats": stats,
        "attempts": attempts,
...
with open("app/routes/trainer_routes.py", "w", encoding="utf-8") as f:
    f.write(trainer_routes_code)

print("app/routes/trainer_routes.py created successfully")
